...
2. Рисунки [-@fig:001;-@fig:002] Переходим  в каталог /tmp и выводим на экран содержимое с помощью команды ls [-@fig:004].
...
![рис.4](image/4.jpg){ #fig:004 width=70% }
 ...
 2.3 Определяем, есть ли в каталоге /var/spool подкаталог с именем cron(рис.5).

![рис.5](image/5.jpg){ #fig:005 width=70% }

2.4 Переходим в домашний каталог и выводим на экран его содержимое. Определяем, кто является владельцем файлов и подкаталогов(рис.6).

![рис.6](image/6.jpg){ #fig:006 width=70% }
св ..
3. 3.1. В домашнем каталоге создаем новый каталог с именем newdir(рис.7).

![рис.7](image/7.jpg){ #fig:007 width=70% }

3.2. В каталоге ~/newdir создаем новый каталог с именем morefun(рис.8).

![рис.8](image/7.jpg){ #fig:008 width=70% }

3.3. В домашнем каталоге создаем одной командой три новых каталога с именами letters, memos, misk. Затем удаляем эти каталоги одной командой.(рис.9).

![рис.9](image/8.jpg){ #fig:009 width=70% }


3.4. Пробуем удалить ранее созданный каталог ~/newdir командой rm. Каталог не был удален (рис.10).

![рис.10](image/9.jpg){ #fig:010 width=70% }

3.5. Удалияем каталог ~/newdir/morefun из домашнего каталога(рис.11). С помощью команды rm -r.
...
входящих в него.(рис.12-13)

![рис.12](image/9.0.jpg){ #fig:012 width=70% }

![рис.13](image/9.1.jpg){ #fig:013 width=70% }
...
с развёрнутым описанием файлов(рис.14-15).

![рис.14](image/9.0.jpg){ #fig:014 width=70% } 

![рис.15](image/10.1.jpg){ #fig:015 width=70% }

6. Используем команду man для просмотра описания следующих команд: cd, pwd, mkdir,
rmdir, rm(рис16).

![рис.16](image/11.1.jpg){ #fig:016 width=70% }

Команда cd используется для перемещения по файловой системе операционной системы типа Linux. Команда cd (рис.17):

![рис.17](image/10.jpg){ #fig:017 width=70% }

Команда pwd используется для определения абсолютного пути к текущему каталогу.
Команда pwd (рис.18):

![рис.18](image/11.jpg){ #fig:018 width=70% }


Команда mkdir используется для создания каталогов.
Команда mkdir (рис.19):

![рис.19](image/12.jpg){ #fig:019 width=70% }
...
r имя_каталога. 
Команда rmdir (рис.20):

![рис.20](image/14.jpg){ #fig:020 width=70% }


Команда rm используется для удаления файлов и/или каталогов.
Команда rm (рис.21):

![рис.21](image/15.jpg){ #fig:021 width=70% }



7. Использовать информацию, полученную при помощи команды history, выполнить модификацию и исполнение нескольких команд из буфера команд(рис.22).

![рис.22](image/18.jpg){ #fig:022 width=70% }

Модификация(рис.23):

![рис.23](image/19.jpg){ #fig:023 width=70% }

Исполнение нескольких команд(рис.24):


![рис.24](image/20.jpg){ #fig:024 width=70% }
