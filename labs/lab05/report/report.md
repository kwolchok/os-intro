...
![Опции команды chmod](image/12.jpg){ #fig:011 width=70% }
...
![ kill ](image/22.jpg){ #fig:020 width=70% }
...
![ mkfs](image/23.jpg){ #fig:021 width=70% }
...
![Формы записи прав доступа](image/25.jpg){ #fig:023 width=70% }
