...
В ходе выполнения лабораторной работы я должна изучить основы программирования в оболочке ОС UNIX/Linux. А также  научиться писать небольшие командные файлы.
...
1.Написала скрипт, который при запуске будет делать резервную копию самого себя (то есть файла, в котором содержится его исходный код) в другую директорию backup в домашнем каталоге. При этом файл должен архивироваться одним из архиваторов на выбор zip, bzip2 или tar. Способ использования команд архивации узнала, изучив справку.(рис. [-@fig:001])(рис. [-@fig:002])(рис. [-@fig:003])(рис. [-@fig:004])(рис. [-@fig:005])(рис. [-@fig:006])

![рис.1](image/2.png){ #fig:001 width=70% }

![рис.2](image/1.png){ #fig:002 width=70% }

![рис.3](image/11.png){ #fig:003 width=70% }

![рис.4](image/12.png){ #fig:004 width=70% }

![рис.5](image/13.png){ #fig:005 width=70% }

![рис.6](image/14.png){ #fig:006 width=70% }
...
![рис.7](image/4.png){ #fig:007 width=70% }

![рис.8](image/5.png){ #fig:008 width=70% }
...
![рис.9](image/6.png){ #fig:009 width=70% }

![рис.10](image/7.png){ #fig:010 width=70% }
...
![рис.11](image/8.png){ #fig:011 width=70% }

![рис.12](image/9.png){ #fig:012 width=70% }
...
В ходе проделанной лабораторной работы я изучила основы программирования в оболочке ОС UNIX/Linux. А также  научилась писать небольшие командные файлы.
